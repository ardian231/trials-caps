        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="{{ route('admin.dashboard') }}" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>UMKVest</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="fa fa-laptop me-2"></i>Data UMKM</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ route('admin.ditolak') }}" class="dropdown-item">Ditolak Sistem</a>
                            <a href="{{ route('admin.diterima') }}" class="dropdown-item">Diterima Sistem</a>
                        </div>
                    </div>
                    <a href="{{ route('admin.investor') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Investor</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <div class="bg-secondary rounded-top p-4">
                <div class="row">
                    <div class="col-12 col-sm-6 text-center text-sm-start">
                        &copy; <a href="#">UMKVest</a>, All Right Reserved.
                    </div>
                </div>
            </div>
        </div>
